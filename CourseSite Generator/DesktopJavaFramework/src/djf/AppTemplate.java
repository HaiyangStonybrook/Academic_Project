...
public abstract class AppTemplate extends Application {
	...
	PropertiesManager props = PropertiesManager.getPropertiesManager();
        ...
        alert.setHeaderText("Please choose the language you prefer ");
        alert.setContentText("Choose your option");

        ButtonType buttonTypeOne = new ButtonType("English");
        ButtonType buttonTypeTwo = new ButtonType("Chinese");
	...
	try {
            ...
            if(english){
               ...
               success = loadProperties(APP_PROPERTIES_FILE_NAME_CHINESE);
