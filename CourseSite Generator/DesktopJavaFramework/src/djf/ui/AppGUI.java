...
public class AppGUI {
    ...
    protected FlowPane undo_redo_about;

    // FILE TOOLBAR BUTTONS
    protected Button newButton;
    protected Button loadButton;
    protected Button saveButton;
    protected Button saveAsButton; // qq
    ...
    public void updateToolbarControls(boolean saved) {
        ...
        saveButton.setDisable(saved); // qq
     ...
     */
    public void initFileToolbar(AppTemplate app) {
        ...
        saveAsButton = initChildButton(fileToolbarPane,	SAVE_AS_ICON.toString(),    SAVE_AS_TOOLTIP.toString(),	true); //qq
        ...
        //exitButton.setPadding(new Insets(0,200,0,0));
        
        
        toolbar = new HBox();
        undoButton = initChildButton(toolbar,   UNDO_ICON.toString(),    UNDO_TOOLTIP.toString(), true );
        redoButton = initChildButton(toolbar,   REDO_ICON.toString(),    REDO_TOOLTIP.toString(), true );
        aboutButton = initChildButton(toolbar,   ABOUT_ICON.toString(),    ABOUT_TOOLTIP.toString(), true );
        fileToolbarPane.getChildren().add(toolbar);
        toolbar.setPadding(new Insets(0,0,0,200));
	...
	saveButton.getStyleClass().add(CLASS_FILE_BUTTON);
        saveAsButton.getStyleClass().add(CLASS_FILE_BUTTON);//qq
        exportButton.getStyleClass().add(CLASS_FILE_BUTTON);//qq
    ...
    public void enableAbout(boolean enable){
        aboutButton.setDisable(!enable);
    }
}
